...
namada:
  ...
  RUN rustup toolchain install $toolchain-x86_64-unknown-linux-gnu --no-self-update --component clippy,rustfmt,rust-docs,rust-src,llvm-tools-preview
  RUN rustup target add --toolchain $toolchain-x86_64-unknown-linux-gnu wasm32-unknown-unknown
  RUN rustup toolchain install $nightly_toolchain-x86_64-unknown-linux-gnu --no-self-update --component clippy,rustfmt,rust-docs,rust-src,llvm-tools-preview,rustc-codegen-cranelift-preview
...
wasm:
  ...
  RUN rustup toolchain install $toolchain --no-self-update --component cargo,rust-std,rustc,rust-docs
  RUN rustup target add --toolchain $toolchain-x86_64-unknown-linux-gnu wasm32-unknown-unknown
  RUN rustup default $toolchain-x86_64-unknown-linux-gnu
